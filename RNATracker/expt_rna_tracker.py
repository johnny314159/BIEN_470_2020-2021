...
# read data
df_train = pd.read_csv('train-'+fname)
df_val = pd.read_csv('val-'+fname)
df_test = pd.read_csv('test-'+fname)
...
df_train = df_train[df_train.species=='hg38']
# df_train = df_train.sample(n=100)
df_val = df_val[df_val.species=='hg38']
df_test = df_test[df_test.species=='hg38']
...
def get_df(df):
    ...
    # print(df.loc[0, 'sequence'])
    # print(df.loc[0, 'req_sequence'])
